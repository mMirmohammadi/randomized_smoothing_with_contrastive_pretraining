...
class Classifier(torch.nn.Module):
    def __init__(
        ...
        self.encoder = SupConResNet(name="resnet34", head="mlp", feat_dim=128)
...
classifierParallel = torch.nn.DataParallel(classifier)
...
train(freeze_epochs, classifierParallel, optimizer, criterion, scheduler)
...
train(unfreeze_epochs, classifierParallel, optimizer, criterion, scheduler)
...
smoothed_classifier = Smooth(classifierParallel, 10, sigma)
...
exp_name = "consistency_finetuned_reduced{}".format(arch_name)
