tag = "TwoHeadWithTheClassificationHead"
...
class Classifier(torch.nn.Module):
    def __init__(
        ...
        self.encoder = SupConResNet(
            name="resnet50", head="mlp", feat_dim=128, multi_head=True
        )
        ...
        try:
            self.encoder.load_state_dict(renamed_state_dict, strict=True)
        except RuntimeError as e:
            print(e)
            print("Trying again with strict=False")
            self.encoder.load_state_dict(renamed_state_dict, strict=False)
