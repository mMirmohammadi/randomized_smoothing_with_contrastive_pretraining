...
# CUDA_VISIBLE_DEVICES=$dev python code/certify.py cifar10 logs/cifar10/consistency/cohen/num_2/lbd_20.0/eta_0.5/noise_0.25/cifar_resnet110/256/0/checkpoint.pth.tar 0.25 \
...
CUDA_VISIBLE_DEVICES=$dev python code/certify.py cifar10 logs/cifar10/consistency/cohen/num_2/lbd_10.0/eta_0.5/noise_0.5/cifar_resnet110/256/0/checkpoint.pth.tar 0.5 \
...
CUDA_VISIBLE_DEVICES=$dev python code/certify.py cifar10 logs/cifar10/consistency/cohen/num_2/lbd_10.0/eta_0.5/noise_1.0/cifar_resnet110/256/0/checkpoint.pth.tar 1.0 \
