...
# CUDA_VISIBLE_DEVICES=$dev python code/certify.py cifar10 logs/cifar10/catrs/adv_256.0_4/lbd_0.5/num_4/noise_0.25/cifar_resnet110/256/0/checkpoint.pth.tar 0.25 \
...
CUDA_VISIBLE_DEVICES=$dev python code/certify.py cifar10 logs/cifar10/catrs/adv_256.0_4/lbd_1.0/num_4/noise_0.5/cifar_resnet110/256/0/checkpoint.pth.tar 0.5 \
...
CUDA_VISIBLE_DEVICES=$dev python code/certify.py cifar10 logs/cifar10/catrs/adv_256.0_4/lbd_2.0/num_4/noise_1.0/cifar_resnet110/256/0/checkpoint.pth.tar 1.0 \
