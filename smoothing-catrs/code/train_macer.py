...
parser.add_argument(
    "--batch", default=64, type=int, metavar="N", help="batchsize (default: 64)"
)
parser.add_argument(
    "--lr",
    "--learning-rate",
...
def main():
    ...
    for epoch in range(starting_epoch, args.epochs):
        before = time.time()
        train_loss = train(
            train_loader, model, optimizer, epoch, args.noise_sd, device, writer
        )
