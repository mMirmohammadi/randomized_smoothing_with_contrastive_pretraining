...
parser.add_argument(
    ...
    default=1,
    type=int,
    help="Number of epochs over which "
...
args.outdir = (
    f"logs/{args.dataset}/salman/{mode}/num_{args.num_noise_vec}/noise_{args.noise_sd}"
)
...
def train(
    ...
    for i, batch in enumerate(loader):
        ...
        for inputs, targets in mini_batches:
            ...
            inputs = inputs.repeat((1, args.num_noise_vec, 1, 1)).reshape(
                -1, *batch[0].shape[1:]
            )
