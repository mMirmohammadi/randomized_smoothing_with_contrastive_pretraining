...
if __name__ == "__main__":
    ...
    pbar = trange(args.start, num_samples)
    rads = []
    for i in pbar:
        ...
        # x = x.cuda()
        certification_results = smoothed_classifier.certify(i, args.N0, args.N, args.alpha, args.batch)
        after_time = time()
