...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channel=3, in_planes=64, zero_init_residual=False):
        ...
        if self.num_layers >= 4: self.layer4 = self._make_layer(block, 8*self.in_planes, num_blocks[3], stride=2)
...
model_dict = {
    ...
    'resnet20': [resnet20, 128],
    "resnet20_slim": [resnet20_slim, 128],
