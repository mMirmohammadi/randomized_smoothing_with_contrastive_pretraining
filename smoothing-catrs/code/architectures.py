...
from convert_to_svm import SVM_Wrapper
import apex
...
ARCHITECTURES = ["lenet", "resnet50", "cifar_resnet20", "cifar_resnet110", "cifar100_resnet110", "supcon_resnet50"]
...
def get_architecture(arch: str, dataset: str) -> torch.nn.Module:
    ...
    elif arch == "svm_resnet50":
        model = SVM_Wrapper(resnet_args=dict(name="resnet50", head="mlp", feat_dim=128))
